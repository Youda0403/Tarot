...
assert(!pose(3100,210,true).held, 'Failed attempt must release the doll');
assert.equal(pose(4000,210,true).prizeY,383);
assert.equal(pose(7000,210,false).x,156);
assert(pose(7900,210,false).result, 'Result stays visible through end of turn');
